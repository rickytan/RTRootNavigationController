...
you can have each view controller a individual navigation bar.
  ...
  s.homepage         = 'https://github.com/wangshaoren/RTRootNavigationController'
  ...
  s.author           = { 'wangshaoren' => '452393578@qq.com' }
  s.source           = { :git => 'https://github.com/wangshaoren/RTRootNavigationController.git', :tag => s.version.to_s }
